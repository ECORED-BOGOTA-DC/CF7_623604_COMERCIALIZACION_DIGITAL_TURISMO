...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .p-4(data-aos="flip-up" style="background-color:#FCC52E;border-radius:15px;")
        .row.m-0
          ...
          .col-lg-3.col-md-3.text-center(style="place-self:center;")
            a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=1p9t9ymdH6Y" target="_blank")
              span Ver video
              i.fas.fa-play
    
    p.mt-5(data-aos="zoom-in") Estos son algunos consejos que pueden ayudar a conocer el público objetivo:
    ...
    ul.fa-ul.mt-4
      ...
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Revisar que cuentas siguen en redes sociales. 
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Segmentar las audiencias.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Investigar el tipo de contenido que consume cada audiencia.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Usar diferentes formatos de contenido.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Elegir los sitios adecuados para publicar contenido.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
    ...
    .col-xl-10.m-auto.mt-5
      .p-4(data-aos="flip-up" style="background-color:#FCC52E;border-radius:15px;")
        .row.m-0
          ...
          .col-lg-3.col-md-3.text-center(style="place-self:center;")
            a.boton.color-acento-botones(href="https://support.google.com/google-ads/answer/7337243?hl=es-419#zippy=%2Cagregue-palabras-clave-al-plan-y-consulte-las-previsiones" target="_blank")
              span Ir a enlace
              i.fas.fa-link
    ...
    .col-xl-10.m-auto.mt-5
      .p-4(data-aos="flip-up" style="background-color:#FCC52E;border-radius:15px;")
        .row.m-0
          ...
          .col-lg-3.col-md-3.text-center(style="place-self:center;")
            a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=dGvw8reGgNg" target="_blank")
              span Ver video
              i.fas.fa-play
    ...
    .titulo-segundo
      h2#t_4_2 4.2  Herramientas de programación de contenidos en redes sociales
    
    p(data-aos="zoom-in") El primer paso para crear un plan de mercadeo de contenido en la empresa del sector turístico es definir los canales disponibles por categoría (propio, ganado o pagado). El siguiente paso es crear un calendario de contenido o publicaciones en donde se especifica cada actividad; para ello, estos son algunos aspectos que se deben considerar:
    ...
    ul.fa-ul.mt-4
      ...
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Detallar las personas o áreas involucradas en el plan de acción.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Definir periodos de tiempo.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Resaltar fechas clave.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Considerar varios canales.
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Definir la audiencia en cada etapa del calendario. 
      li.mb-2(data-aos="zoom-in")
        i.fas.fa-caret-right.fa-li(style="color:#FFB338;")
        | Escoger las herramientas en línea.
    ...
    p.mt-5(data-aos="zoom-in") Una vez contemplados los aspectos anteriormente mencionados, es conveniente elegir una herramienta digital que le permita a la empresa del sector turístico automatizar el proceso. Existen varias que permiten crear el calendario y publicar el contenido en las redes sociales, algunas son de pago y otras gratuitas, lo importante es realizar la elección que más se ajuste a las necesidades de la empresa; a continuación, se presentan algunas de estas:
